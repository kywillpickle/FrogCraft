package net.topnotchgames.frogcraft.common.entity.animation;
...
public class CrimsonFrogAnimation {
	public static final AnimationDefinition MODEL_CROAK = AnimationDefinition.Builder.withLength(0.5833F)
		.addAnimation("base", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.001F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("eyes", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.0417F, KeyframeAnimations.posVec(0.0F, 0.1F, -0.2F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("throat", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 0.0F, -1.4F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("throat", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(0.125F, KeyframeAnimations.scaleVec(1.3F, 1.2F, 1.5F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition MODEL_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("fl_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-13.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.0833F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.4167F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(13.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(-13.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("fl_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, 0.75F, 0.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.875F, KeyframeAnimations.posVec(0.0F, 0.75F, -0.5F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("bl_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("br_leg", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, 0.75F, 0.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("eyes", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.035F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
	...
	public static final AnimationDefinition MODEL_TONGUE = AnimationDefinition.Builder.withLength(0.5F)
		...
		.addAnimation("tongue", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(0.1667F, KeyframeAnimations.scaleVec(0.7F, 1.0F, 4.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.3333F, KeyframeAnimations.scaleVec(0.7F, 1.0F, 3.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition MODEL_JUMP = AnimationDefinition.Builder.withLength(0.5417F)
		...
		.addAnimation("fl_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(-74.4959F, -14.4775F, -3.9671F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("bl_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
